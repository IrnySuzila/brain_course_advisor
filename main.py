...
def main():
    st.markdown(f"<br>", unsafe_allow_html=True)
    st.write("<b>Welcome to the Brain-based Course Field Advisor Application. I will ask you 10 questions to determine your brain dominance and suggest suitable careers and courses field for you.</b>", unsafe_allow_html=True)
    st.markdown(f"<br>", unsafe_allow_html=True)
    ...
    if st.session_state.chosen_careers:
        for career in st.session_state.chosen_careers:
            ...
            if courses:  # Check if there are courses for the career
                st.write(f"<b>To pursue this career, you can consider the courses field in the following field/domain :</b>", unsafe_allow_html=True)
    ...
    # Title and description of the web application
            ...
            st.write('<b>Besides the suggested career and course field, you can explore other related careers and course field that you think are suitable for your future based on your brain-hemisphere dominance characteristics.</b>', unsafe_allow_html=True)
            #st.markdown(f"<br>", unsafe_allow_html=True)
    # Disclaimer
            st.write('<br><br><b>Disclaimer</b>: The information and recommendations provided by this brain-based career and course field advisor app are intended for general guidance and informational purposes only and should not be construed as professional career and education advice. While the app utilizes advanced algorithms and cognitive science principles to offer career insights, it does not guarantee specific outcomes or results. Users should consult with qualified career professionals or advisors before making any significant career or education decisions. The developers of this app expressly disclaim any liability for any actions taken or not taken based on the information provided, and users assume all risks associated with their use of the app.', unsafe_allow_html=True)
