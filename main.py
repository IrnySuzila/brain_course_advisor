...
def main():
    ...
    # Title and description of the web application
            ...
            st.write('<b>Besides the suggested career and course field, you can explore other related careers and course that you think are suitable for your future based on your brain-hemisphere dominance characteristics.</b>', unsafe_allow_html=True)
            #st.markdown(f"<br>", unsafe_allow_html=True)
    # Disclaimer
